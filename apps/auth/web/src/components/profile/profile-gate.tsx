...
import { OpenAddProfileProvider } from './profile-gate-context';
...
export function ProfileGate() {
  ...
  return (
    <OpenAddProfileProvider value={() => setAddOpen(true)}>
      <div
        className={cn(
          'flex flex-col items-center animate-profile-gate transition-opacity duration-500',
      ...
      <Button
        ...
        className={cn(
          'h-auto cursor-pointer rounded-none px-[1.5em] py-[0.6em] text-[clamp(14px,1.2vw,18px)] tracking-wider transition-colors',
          editing
